      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            The direction and goals that guide the journey of <span className="text-[#E85C23] font-medium">PT. Batara Dharma Persada</span> towards excellence in mining operations.
          </p>
          
          <div className="flex justify-center">
            <div className="animate-bounce mt-8">
              <ChevronDown className="w-8 h-8 text-[#1FBFB8]" />
            </div>
          </div>
        </div>
      </div>
