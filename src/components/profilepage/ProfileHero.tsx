      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Discover how <span className="text-[#E85C23] font-medium">PT. Batara Dharma Persada</span> became a trusted mining and hauling partner across Indonesia's resource sector.
          </p>
