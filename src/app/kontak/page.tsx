      ...
      import('leaflet').then(L => {
        ...
        setTimeout(() => {
          ...
          if (mapContainer && !mapContainer.hasChildNodes()) {
            ...
            headOfficeMarker.bindPopup("<b>Kantor Pusat PT BATARA</b><br>Jl. Agung Sedayu City Boulevard Utara No.58, Cakung Bar., Kec. Cakung, Kota Jakarta Timur, DKI Jakarta 13910").openPopup();
          }
      ...
      <section className="bg-blue-700 text-white py-24 px-4 md:px-8 lg:px-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto opacity-90">
            Kami siap mendengarkan pertanyaan, saran, atau kebutuhan Anda terkait layanan transportasi batubara
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      <br />Kec. Cakung, Kota Jakarta Timur, DKI Jakarta 13910
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      +62 21 5437 8932 <span className="text-gray-400">(Kantor)</span>
                      <br />
                      +62 812 9876 5432 <span className="text-gray-400">(Layanan Pelanggan)</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      info@batara.id <span className="text-gray-400">(Informasi Umum)</span>
                      <br />
                      sales@batara.id <span className="text-gray-400">(Kerjasama Bisnis)</span>
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 reveal-contact opacity-0 translate-y-6 transition-all duration-700">
            <h2 className="text-3xl font-bold mb-4 relative inline-block">
              <span className="relative z-10">Lokasi Kami</span>
              <span className="absolute -bottom-2 left-0 w-full h-3 bg-blue-300 opacity-40 z-0"></span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Kunjungi kantor pusat PT Batara Dharma Persada di Jakarta Timur
            </p>
          </div>
