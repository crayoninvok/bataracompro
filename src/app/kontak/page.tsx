          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="reveal-contact opacity-0 translate-y-6 transition-all duration-700">
              <h2 className="text-3xl font-bold mb-6 relative inline-block">
                <span className="relative z-10 text-[#5B5B5F]">Contact Information</span>
                <span className="absolute -bottom-2 left-0 w-full h-3 bg-[#E85C23] opacity-40 z-0"></span>
              </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-[#1FBFB8]/20 p-3 rounded-full mr-4">
                    <Building className="w-5 h-5 text-[#1FBFB8]" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-[#5B5B5F]">Head Office</h3>
                ...
                <div className="flex items-start">
                  <div className="bg-[#E85C23]/20 p-3 rounded-full mr-4">
                    <Phone className="w-5 h-5 text-[#E85C23]" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-[#5B5B5F]">Phone</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-[#5B5B5F]">Email</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start">
                  <div className="bg-[#E85C23]/20 p-3 rounded-full mr-4">
                    <Clock className="w-5 h-5 text-[#E85C23]" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-1 text-[#5B5B5F]">Operating Hours</h3>
                    <p className="text-gray-600">
              ...
              {/* Social Media Links */}
              <div className="mt-12">
                <h3 className="font-bold text-lg mb-4 text-[#5B5B5F]">Follow Us</h3>
                <div className="flex space-x-4">
                  <a 
                    href="https://instagram.com/pt_batara" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-gray-100 hover:bg-[#E85C23]/20 transition p-3 rounded-full"
                  >
                    <Instagram className="w-6 h-6 text-gray-700 hover:text-[#E85C23] transition" />
                  </a>
                  <a 
                    href="https://facebook.com/ptbatara" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-gray-100 hover:bg-[#1FBFB8]/20 transition p-3 rounded-full"
                  >
                    <Facebook className="w-6 h-6 text-gray-700 hover:text-[#1FBFB8] transition" />
                  </a>
                  <a 
                    ...
                    className="bg-gray-100 hover:bg-[#1FBFB8]/20 transition p-3 rounded-full"
                  >
                    <Linkedin className="w-6 h-6 text-gray-700 hover:text-[#1FBFB8] transition" />
                  </a>
                  <a 
                    ...
                    className="bg-gray-100 hover:bg-[#1FBFB8]/20 transition p-3 rounded-full"
                  >
                    <Twitter className="w-6 h-6 text-gray-700 hover:text-[#1FBFB8] transition" />
                  </a>
                  <a 
                    ...
                    className="bg-gray-100 hover:bg-[#E85C23]/20 transition p-3 rounded-full"
                  >
                    <Youtube className="w-6 h-6 text-gray-700 hover:text-[#E85C23] transition" />
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="reveal-contact opacity-0 translate-y-6 transition-all duration-700 delay-200">
              <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-gray-100">
                <h2 className="text-2xl font-bold mb-6 text-[#5B5B5F]">Send a Message</h2>
                <form onSubmit={handleSubmit}>
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1FBFB8] focus:border-[#1FBFB8]"
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#E85C23] hover:bg-[#d14b17] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E85C23] transition"
                      >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 reveal-contact opacity-0 translate-y-6 transition-all duration-700">
            <h2 className="text-3xl font-bold mb-4 relative inline-block">
              <span className="relative z-10 text-[#5B5B5F]">Our Location</span>
